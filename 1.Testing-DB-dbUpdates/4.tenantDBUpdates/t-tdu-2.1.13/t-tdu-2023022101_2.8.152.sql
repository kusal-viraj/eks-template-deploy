...
UPDATE common_grid_column_template tmp SET tmp.sortable_field='vendor.name' WHERE tmp.field='vendor.id' AND tmp.grid_id=14;
UPDATE common_grid_column_user_wice tmp SET tmp.sortable_field='vendor.name' WHERE tmp.field='vendor.id' AND tmp.grid_id=14;
