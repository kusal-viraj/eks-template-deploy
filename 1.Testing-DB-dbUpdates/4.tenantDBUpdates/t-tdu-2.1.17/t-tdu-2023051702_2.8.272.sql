...
ALTER TABLE hst_vp_po_workflow_detail_config ADD COLUMN action_date DATETIME NULL DEFAULT NULL AFTER action_user;

ALTER TABLE hst_vp_bill_workflow_detail_config ADD COLUMN action_date DATETIME NULL DEFAULT NULL AFTER action_user;