...
UPDATE `common_drop_down_value` SET `value`='TRUE' WHERE (`id`='9');

UPDATE `common_drop_down_value` SET `value`='FALSE' WHERE (`id`='10');

UPDATE `common_grid_column_template` SET `drop_down_id`='10' WHERE (`id`='88');

UPDATE `common_grid_column_template` SET `drop_down_id`='1' WHERE (`id`='89');

UPDATE common_grid_column_user_wice SET drop_down_id=10 WHERE grid_id=11 AND field='field.required';

UPDATE common_grid_column_user_wice SET drop_down_id=1 WHERE grid_id=11 AND field='field.status';