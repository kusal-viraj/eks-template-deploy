...
--
-- Table structure for table `vp_payment_type_detail`
--

DROP TABLE IF EXISTS `vp_payment_type_detail`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `vp_payment_type_detail` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `vp_payment_type_detail`
--

LOCK TABLES `vp_payment_type_detail` WRITE;
/*!40000 ALTER TABLE `vp_payment_type_detail` DISABLE KEYS */;
INSERT INTO `vp_payment_type_detail` VALUES (1,2,1,'Company ID',NULL,1),(2,2,2,'Accounting Number',NULL,1),(3,2,2,'Routing Number',NULL,2),(4,2,3,'Account ID',NULL,1),(5,2,4,'Account ID',NULL,1);
/*!40000 ALTER TABLE `vp_payment_type_detail` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2023-03-20 11:38:56
