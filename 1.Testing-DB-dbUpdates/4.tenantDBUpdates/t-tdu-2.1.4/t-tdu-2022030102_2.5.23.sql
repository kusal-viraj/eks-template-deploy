...
WHERE po.remaining_celing<=0 AND (po.remaining_price_variance=0 OR po.remaining_price_variance IS NULL);

UPDATE vp_po_mst po SET po.po_status='P'
WHERE po.remaining_celing > 0 OR po.remaining_price_variance > 0;
...
UPDATE common_grid_state_user_wice userWise SET userWise.column_widths='50,100,220,218,214,218,218,219,219,219,219,219,219,219,219,219,219' WHERE userWise.grid_id=13;
