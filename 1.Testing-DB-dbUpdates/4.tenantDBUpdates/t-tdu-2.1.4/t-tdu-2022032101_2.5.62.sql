...
INSERT INTO umm_role_previlege(role_id,privilege_id,created_by,created_on,sub_account_id)
SELECT role_id,471,created_by,created_on,sub_account_id from umm_role_previlege WHERE privilege_id IN(SELECT id FROM umm_menu_privilage WHERE menu_id=1045) GROUP BY role_id;

INSERT INTO umm_role_previlege(role_id,privilege_id,created_by,created_on,sub_account_id)
SELECT role_id,472,created_by,created_on,sub_account_id from umm_role_previlege WHERE privilege_id IN(SELECT id FROM umm_menu_privilage WHERE menu_id=1018) GROUP BY role_id;


INSERT INTO umm_role_previlege(role_id,privilege_id,created_by,created_on,sub_account_id)
SELECT role_id,474,created_by,created_on,sub_account_id from umm_role_previlege WHERE privilege_id IN(SELECT id FROM umm_menu_privilage WHERE menu_id=1027) GROUP BY role_id;


INSERT INTO umm_role_previlege(role_id,privilege_id,created_by,created_on,sub_account_id)
SELECT role_id,475,created_by,created_on,sub_account_id from umm_role_previlege WHERE privilege_id IN(SELECT id FROM umm_menu_privilage WHERE menu_id=1028) GROUP BY role_id;


INSERT INTO umm_role_previlege(role_id,privilege_id,created_by,created_on,sub_account_id)
SELECT role_id,473,created_by,created_on,sub_account_id from umm_role_previlege WHERE privilege_id IN(SELECT id FROM umm_menu_privilage WHERE menu_id=1043) GROUP BY role_id;


INSERT INTO umm_role_previlege(role_id,privilege_id,created_by,created_on,sub_account_id)
SELECT role_id,476,created_by,created_on,sub_account_id from umm_role_previlege WHERE privilege_id IN(SELECT id FROM umm_menu_privilage WHERE menu_id=1044) GROUP BY role_id;
