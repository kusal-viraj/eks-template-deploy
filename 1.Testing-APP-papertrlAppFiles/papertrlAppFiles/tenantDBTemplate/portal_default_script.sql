...
--
-- Table structure for table `vp_bill_approval_stamp_format`
--

DROP TABLE IF EXISTS `vp_bill_approval_stamp_format`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `vp_bill_approval_stamp_format`
--

LOCK TABLES `vp_bill_approval_stamp_format` WRITE;
/*!40000 ALTER TABLE `vp_bill_approval_stamp_format` DISABLE KEYS */;
INSERT INTO `vp_bill_approval_stamp_format` VALUES (8,'Default','DEFAULT',1),(9,'TIDEWATER','TW',0);
/*!40000 ALTER TABLE `vp_bill_approval_stamp_format` ENABLE KEYS */;
UNLOCK TABLES;
