...
ALTER TABLE `vendor_w9_attachment`
DROP COLUMN `w9_form_data`,
CHANGE COLUMN `vendor_id` `vendor_mst_id`  int(11) NULL AFTER `id`,
ADD COLUMN `vendor_temp_id`  int(11) NULL AFTER `vendor_mst_id`,
ADD COLUMN `file_name`  varchar(200) NOT NULL AFTER `vendor_temp_id`,
