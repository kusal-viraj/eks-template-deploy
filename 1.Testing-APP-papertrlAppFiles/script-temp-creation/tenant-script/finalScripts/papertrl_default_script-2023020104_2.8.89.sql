...
--
-- Table structure for table `vp_payment_type_details`
--

DROP TABLE IF EXISTS `vp_payment_type_details`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `vp_payment_type_details`
--

LOCK TABLES `vp_payment_type_details` WRITE;
/*!40000 ALTER TABLE `vp_payment_type_details` DISABLE KEYS */;
INSERT INTO `vp_payment_type_details` VALUES (1,2,1,'Company ID',NULL,1),(2,2,2,'Accounting Number',NULL,1),(3,2,2,'Routing Number',NULL,2),(4,2,3,'Account ID',NULL,1),(5,2,4,'Account ID',NULL,1);
/*!40000 ALTER TABLE `vp_payment_type_details` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2023-02-01  9:00:48
