...
CREATE TABLE `vp_credit_card_statement_detail` (
  ...
  `amount` decimal(19,2) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `STATEMENT_ID_FK_3` (`statement_id`) USING BTREE,
...
-- Dump completed on 2022-04-25 10:06:39
