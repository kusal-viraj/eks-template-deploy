...
--
-- Table structure for table `vp_payment_transaction_audit_trial_data`
--

DROP TABLE IF EXISTS `vp_payment_transaction_audit_trial_data`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `vp_payment_transaction_audit_trial_data` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `audit_trial_id` int(11) NOT NULL,
...
--
-- Dumping data for table `vp_payment_transaction_audit_trial_data`
--

LOCK TABLES `vp_payment_transaction_audit_trial_data` WRITE;
/*!40000 ALTER TABLE `vp_payment_transaction_audit_trial_data` DISABLE KEYS */;
/*!40000 ALTER TABLE `vp_payment_transaction_audit_trial_data` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2023-04-25 12:41:27
