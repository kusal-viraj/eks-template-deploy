...
CREATE TABLE `vp_payment_v_card` (
  ...
  `card_owner` varchar(200) DEFAULT NULL,
  `amount` decimal(19,2) NOT NULL,
  `balance_amount` decimal(19,2) DEFAULT NULL,
...
-- Dump completed on 2023-05-18 12:15:03
