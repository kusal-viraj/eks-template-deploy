...
UPDATE vp_po_account_detail SET credit_note_balance = amount;

INSERT INTO common_grid_column_user_wice (user_id, grid_id, field, sortable_field, header, column_show, is_sortable, is_re_orderable, is_re_sizable, can_hide, filter_show, is_frozen, align, search_type, placeholder, column_order, drop_down_id, column_width)
SELECT DISTINCT user_id, 49, 'creditNote.exportStatus', 'creditNote.exportStatus', 'Export Status', '1', '1', '0', '1', '1', '1', '0', 'left', 'dropdown', 'Export Status', '16', '14', '150'
FROM common_grid_column_user_wice
WHERE grid_id = 49;
