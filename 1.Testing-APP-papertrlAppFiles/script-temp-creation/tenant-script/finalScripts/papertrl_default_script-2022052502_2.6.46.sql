...
INSERT INTO `common_automation_document_type` VALUES (1,'Bill','BILL','A',0,1,1),(2,'Purchase Order','PO','A',1,1,0),(3,'Purchase Order Receipt','PO_RECEIPT','A',0,1,0),(4,'Expense Report','EXPENSE','A',0,1,0),(5,'Payment','BILL_PAYMENT','A',0,1,0),(6,'Vendor','VENDOR','A',0,0,0),(8,'Credit Note','CREDIT_NOTE','A',0,0,0),(9,'Credit Card','CREDIT_CARD','A',0,0,0);
...
-- Dump completed on 2022-05-25 18:07:24
