...
UPDATE common_document_field_section_config SET section_id=1 ,enable=false WHERE id=8;
UPDATE common_document_field_section_config SET section_id=2 ,enable=false WHERE id=9;
UPDATE common_document_field_section_config SET section_id=9 ,enable=false WHERE id=10;