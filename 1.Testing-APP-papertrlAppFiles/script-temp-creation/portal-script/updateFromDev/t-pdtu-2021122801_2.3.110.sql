...
UPDATE `umm_menu_privilage` SET `privilage_id`='84' WHERE  `id`=385;
UPDATE `umm_menu_privilage` SET `privilage_id`='85' WHERE  `id`=386;
UPDATE `umm_menu_privilage` SET `privilage_id`='86' WHERE  `id`=387;
UPDATE `umm_menu_privilage` SET `privilage_id`='87' WHERE  `id`=388;

DELETE FROM `umm_menu_privilage` WHERE  `id`=389;
DELETE FROM `umm_menu_privilage` WHERE  `id`=392;
DELETE FROM `umm_menu_privilage` WHERE  `id`=393;
DELETE FROM `umm_menu_privilage` WHERE  `id`=394;
DELETE FROM `umm_menu_privilage` WHERE  `id`=395;
