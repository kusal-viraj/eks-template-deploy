...
CREATE TABLE `vp_bill` (
  ...
  CONSTRAINT `vp_bill_common_inbox_attachment_id_fk` FOREIGN KEY (`inbox_attachment_id`) REFERENCES `common_inbox_attachment` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-12-08  9:33:53
