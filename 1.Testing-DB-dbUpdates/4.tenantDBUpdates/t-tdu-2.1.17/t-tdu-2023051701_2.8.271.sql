...
UPDATE vp_bill bill SET bill.pay_when_customer_pay=false WHERE bill.id<>0;
UPDATE hst_vp_bill hstbill SET hstbill.pay_when_customer_pay=false WHERE hstbill.id<>0;