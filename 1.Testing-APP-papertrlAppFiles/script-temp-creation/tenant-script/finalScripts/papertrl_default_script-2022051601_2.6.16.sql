...
INSERT INTO `common_grid_template` VALUES (1,'ROLE_LIST'),(2,'USER_LIST'),(3,'APPROVAL_GROUP_LIST'),(4,'ACCOUNT_LIST'),(5,'ITEM_LIST'),(6,'SUB_ACCOUNT_LIST'),(7,'BILL_PAYMENT_LIST'),(8,'COMMUNITY_VENDOR_LIST'),(9,'VENDOR_REQUEST_LIST'),(10,'PROJECT_CODE_LIST'),(11,'ADDITIONAL_FIELD_LIST'),(12,'AUTOMATION_LIST'),(13,'PO_LIST'),(14,'BILL_LIST'),(15,'EXPENSE_LIST'),(16,'PO_RECEIPT_LIST'),(17,'VENDOR_INVITATION_LIST'),(18,'SYNC_ACCOUNT_PROCESSING_LIST'),(19,'SYNC_ACCOUNT_PENDING_LIST'),(20,'SYNC_ACCOUNT_COMPLETED'),(21,'SYNC_ACCOUNT_FAILED_LIST'),(22,'VENDOR_BILL_LIST'),(23,'VENDOR_BILL_PAYMENT_LIST'),(24,'VENDOR_PURCHASE_ORDER_LIST'),(25,'VENDOR_PO_RECEIPTS'),(26,'DISCOUNT_APPLICABLE_LIST'),(27,'PO_NUMBER_CONFIGURATION_LIST'),(28,'TGRID_BILL_LIST'),(29,'TGRID_PO_LIST'),(30,'TGRID_EXP_LIST'),(31,'OCR_BILL_TEMPLATE'),(32,'PAYMENT_APPROVED_BILL'),(33,'PAYMENT_UNDER_APPROVED_BILL'),(34,'PAYMENT_REVIEW'),(35,'PAYMENT_UNDER_REVIEW'),(36,'PAYMENT_BATCH_WISE'),(37,'PAYMENT_UNDER_BATCH_WISE'),(38,'PAYMENT_VENDOR_WISE'),(39,'PAYMENT_UNDER_VENDOR_WISE'),(40,'RECURRING_BILL_TEMPLATE_LIST'),(41,'BATCH_DETAIL_VIEW'),(42,'BATCH_UNDER_DETAIL_VIEW'),(43,'VENDOR_WISE_SUMMARY'),(44,'VENDOR_WISE_UNDER_SUMMARY'),(45,'PAYMENT_ADD_BILLS'),(46,'DEPARTMENT_LIST'),(47,'PROJECT_CODE_BILLS'),(48,'PO_PRICE_VARIANCE_LIST'),(49,'CREDIT_NOTE_LIST'),(50,'CREDIT_CARD_STATEMENT_UPLOAD_LIST'),(51,'CREDIT_CARD_STATEMENT_CREDIT_CARD_LIST'),(52,'SUPPORT_TICKET');
...
CREATE TABLE `vp_credit_card_statement_detail` (
  ...
  `four_digit_number` varchar(50) DEFAULT NULL,
  `description` varchar(300) DEFAULT NULL,
  `amount` decimal(19,2) DEFAULT NULL,
  `process_statement_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `PROCESS_STATEMENT_ID_FK` (`process_statement_id`),
  KEY `STATEMENT_ID_FK_3` (`statement_id`),
  CONSTRAINT `PROCESS_STATEMENT_ID_FK` FOREIGN KEY (`process_statement_id`) REFERENCES `vp_credit_card_process_mst` (`id`),
...
-- Dump completed on 2022-05-16 14:07:30
