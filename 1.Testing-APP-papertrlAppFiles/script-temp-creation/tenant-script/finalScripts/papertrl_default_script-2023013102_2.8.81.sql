...
--
-- Table structure for table `vp_payment_recipient_details`
--

DROP TABLE IF EXISTS `vp_payment_recipient_details`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `vp_payment_recipient_details`
--

LOCK TABLES `vp_payment_recipient_details` WRITE;
/*!40000 ALTER TABLE `vp_payment_recipient_details` DISABLE KEYS */;
/*!40000 ALTER TABLE `vp_payment_recipient_details` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2023-01-31  9:26:37
