...
INSERT INTO `common_automation_document_action_config` VALUES (1,1,1,1),(2,1,1,2),(3,1,1,3),(4,1,1,4),(5,1,2,2),(6,1,2,3),(7,1,2,4),(8,1,3,2),(9,1,3,3),(10,1,3,4),(11,1,3,6),(12,1,4,2),(13,1,4,3),(14,1,5,2),(15,1,5,3),(16,1,6,2),(17,1,6,3),(18,1,6,6),(19,1,10,2),(20,1,10,3),(21,2,1,1),(22,2,1,2),(23,2,1,3),(24,2,1,4),(25,2,2,2),(26,2,2,3),(27,2,2,4),(28,2,3,2),(29,2,3,3),(30,2,3,4),(31,2,3,6),(32,2,4,2),(33,2,4,3),(34,2,5,2),(35,2,5,3),(36,2,6,2),(37,2,6,3),(38,2,6,6),(39,2,10,2),(40,2,10,3),(41,4,1,1),(42,4,1,2),(43,4,1,3),(44,4,1,4),(45,4,2,2),(46,4,2,3),(47,4,2,4),(48,4,3,2),(49,4,3,3),(50,4,3,4),(51,4,3,6),(52,4,4,2),(53,4,4,3),(54,4,5,2),(55,4,5,3),(56,4,6,2),(57,4,6,3),(58,4,6,6),(59,4,10,2),(60,4,10,3),(61,2,7,2),(62,2,7,3),(63,3,8,2),(64,3,8,3),(65,3,8,6),(66,3,6,2),(67,3,6,3),(68,3,6,6),(69,5,8,2),(70,5,8,3),(71,5,8,6),(72,5,9,2),(73,5,9,3),(74,5,9,6),(75,5,11,2),(76,5,11,3),(77,5,11,6),(78,5,12,2),(79,5,12,3),(80,5,13,2),(81,5,13,3),(82,5,13,6),(83,1,14,2),(84,1,14,3),(85,2,14,2),(86,2,14,3),(87,4,14,2),(88,4,14,3),(89,1,9,2),(90,1,9,3),(91,3,2,2),(92,3,2,3),(93,3,2,6),(94,5,1,1),(95,1,3,1),(96,2,3,1),(97,4,3,1),(98,5,3,1);
...
INSERT INTO `common_automation_event` VALUES (1,'Submit',0),(2,'Edit & Resubmit',0),(3,'Approve',0),(4,'Reject',0),(5,'Skip Approval',0),(6,'Delete',0),(7,'Send to Vendor',0),(8,'Create',0),(9,'Upload',0),(10,'Reassign',0),(11,'Void',0),(12,'Mark as Mail',0),(13,'Apply to Different Bill',0),(14,'Save as Approve',0);
...
) ENGINE=InnoDB AUTO_INCREMENT=14586 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `vp_bill_template_email` (
  ...
  KEY `vp_bill_template_email_vp_bill_template_mst_id_fk` (`template`),
  CONSTRAINT `vp_bill_template_email_vp_bill_template_mst_id_fk` FOREIGN KEY (`template`) REFERENCES `vp_bill_template_mst` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-11-19 12:19:04
