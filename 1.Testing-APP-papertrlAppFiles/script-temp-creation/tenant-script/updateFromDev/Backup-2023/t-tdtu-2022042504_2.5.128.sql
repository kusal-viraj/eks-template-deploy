...
INSERT INTO `umm_menu_privilage`(`menu_id`, `privilage_id`, `auth_code`, `created_by`, `created_on`) VALUES (1049, 128, 'BILL_APPLY_CREDIT_NOTE', 'System', '2022-04-25 16:05:25');

INSERT INTO `umm_role_previlege`(`role_id`, `privilege_id`, `created_by`, `created_on`) VALUES (1, 483, 'system', '2022-04-25 16:11:47');

INSERT INTO `umm_role_previlege`(`role_id`, `privilege_id`, `created_by`, `created_on`) VALUES (1, 484, 'system', '2022-04-25 16:12:42');